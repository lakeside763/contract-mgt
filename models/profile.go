...
type Profile struct {
	...
	FirstName  string       `json:"first_name" gorm:"type:varchar(255);column:first_name" validate:"required"`
	LastName   string       `json:"last_name" gorm:"type:varchar(255);column:last_name" validate:"required"`
