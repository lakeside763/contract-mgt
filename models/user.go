...
type User struct {
	...
	Username 	string 			`json:"username" gorm:"type:varchar(225);column:username" validate:"required,min=3,max=20"`
	Password 	string 			`json:"password" gorm:"type:varchar(225);column:password" validate:"required,min=6"`
